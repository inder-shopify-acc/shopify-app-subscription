...
(function( $ ){
						   ...
						   'insert_link': { "modal": true,
											...
											"onSave":function(){
												...
												if(!checkUrlValid(targetURL)){
													methods.showMessage.apply(editorObj,["errMsg","Url must be contains store url or social media link"]);
													return false;
												}												
												if(range=='' && targetText==''){ 
	...
	const checkUrlValid = (targetURL)=> {
		if(!targetURL.includes(store) && !targetURL.includes("facebook.com") && !targetURL.includes("instagram.com") && !targetURL.includes("youtube.com") && !targetURL.includes("pinterest.com") && !targetURL.includes("reddit.com") && !targetURL.includes("whatsapp.com") && !targetURL.includes("t.me") && !targetURL.includes("skype.com") && !targetURL.includes("xing.com") && !targetURL.includes("getpocket.com") && !targetURL.includes("linkedin.com")){
			return false
		}else {
			return true
		}
